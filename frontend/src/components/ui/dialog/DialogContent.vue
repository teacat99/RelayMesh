...
<template>
  <DialogPortal>
    <DialogOverlay class="fixed inset-0 z-[60] bg-black/60 backdrop-blur-xs data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
